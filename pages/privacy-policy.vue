<template>
    <div>
      ...
      <ul>
        ...
        <li>Communicate with you, including responding to your comments,
          questions, and requests;</li>
        <li>Send you promotional information, updates, and other marketing
          communications;</li>
        <li>Monitor and analyze trends, usage, and activities in connection with
          our website; and</li>
      ...
      <p>
        ...
        information. However, please be aware that no method of transmission over
